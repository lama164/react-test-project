...
export default function WebsiteCategories() {
  ...
  const showCategories = categories.map((item) => (
    <div className="col-lg-2 col-md-6 col-12 b-transparent border-0">
      ...
      <div className="bg-secondary py-5">
        <Container>
          <div className="d-flex align-items-stretch justify-content-center flex-wrap row-gap-2">
            {loading ? (
              <>
              <SkeletonShow length="15" height="70px" classes="col-lg-2 col-md-6 col-12" />
              </>
            ) : showCategories}
          </div>
        </Container>
